...
.page\_body.has-vertical-ads .centered .centered-bottom{
...
#page\_body .FeaturedPost,.Blog .blog-posts .post-outer-container{
...
1. timestamp-link,a:active.timestamp-link,a:visited.timestamp-link{
...
.sidebar-container,.sidebar-container .sidebar\_bottom{

background-color:$(sidebar.backgroundColorBottom)

}

.sidebar-container .navigation,.sidebar-container .sidebar\_top\_wrapper{

background-color:$(sidebar.backgroundColorTop)

}

.sidebar-container .sidebar\_top{

overflow:auto

}

.sidebar-container .sidebar\_bottom{
...
body.sidebar-visible .page\_body{
...
.sidebar-container .sidebar\_top\_wrapper{
...
.sidebar-container .sidebar\_top:empty{

display:none

}

.sidebar-container .sidebar\_top>:only-child{
...
.sidebar\_top\_wrapper.no-items{
...
.sidebar\_bottom .popular-posts-snippet .snippet-fade{
...
#page\_body.section div.widget.FeaturedPost,div.widget.PopularPosts{
...
#page\_body.section div.widget.FeaturedPost h3 a{
...
.page\_body.has-vertical-ads .vertical-ad-container,.page\_body.has-vertical-ads .vertical-ad-container ins{

display:none

}

.page\_body.has-vertical-ads .centered .centered-bottom,.page\_body.has-vertical-ads .centered .centered-top{
...
body.collapsed-header .page\_body .centered-top-container{
...
body#layout .sidebar\_top,

body#layout .sidebar\_bottom {
...
<b:with value='data:widgets.FeaturedPost filter (w =&gt; w.sectionId == &quot;page\_body&quot;) map (w =&gt; w.postId)' var='featuredPostIds'>
...
<b:include cond='data:widget.sectionId == &quot;page\_list\_top&quot;' name='overflowablePageList'/>

<b:include cond='data:widget.sectionId != &quot;page\_list\_top&quot;' name='pageList'/>
...
<b:include cond='not data:view.isPreview' data='{                         image: data:skin.vars.body\_background.image,                         selector: &quot;.bg-photo&quot;,                         imageSizes: [480, 640, 800, 1200, 1600]                      }' name='responsiveImageStyle'/>
...
<script async='async' src='https://www.gstatic.com/external\_hosted/clipboardjs/clipboard.min.js'/>
...
<a class='return\_link' expr:href='data:blog.homepageUrl'>
...
<b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;search\_top&quot;)'>
...
<b:section id='search\_top' name='Search (Top)' showaddelement='false'>
...
<b:widget id='Header1' locked='true' title='ArtikelData (Header)' type='Header' visible='true'>
...
<b:include cond='data:imagePlacement in {&quot;REPLACE&quot;, &quot;BEFORE\_DESCRIPTION&quot;}' name='image'/>

<b:include cond='data:imagePlacement not in {&quot;REPLACE&quot;, &quot;BEFORE\_DESCRIPTION&quot;}' name='title'/>
...
<b:section class='clearboth' id='page\_list\_top' name='Page List (Top)' showaddelement='false'>

<b:widget cond='!data:view.isPost' id='PageList1' locked='true' title='' type='PageList' visible='false'>

<b:widget-settings>

<b:widget-setting name='pageListJson'><![CDATA[{"home":{"href":"http://artikeldatar.blogspot.com/","position":0,"title":"Beranda"}}]]></b:widget-setting>
...
<b:section class='main' id='page\_body' name='Page Body' showaddelement='false'>
...
<img src='https://resources.blogblog.com/img/icon\_delete13.gif'/>
...
<b:template-script inline='true' name='threaded\_comments'/>
...
<b:widget-setting name='timeRange'>LAST\_YEAR</b:widget-setting>
...
<div class='sidebar\_top\_wrapper'>

<b:class cond='data:widgets none w =&gt; w.sectionId == &quot;sidebar\_top&quot;' name='no-items'/>

<b:section class='sidebar\_top' id='sidebar\_top' name='Sidebar (Top)'>
...
<b:section class='sidebar\_bottom' id='sidebar\_bottom' name='Sidebar (Bottom)' preferred='yes'>
